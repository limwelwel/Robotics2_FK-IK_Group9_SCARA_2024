...
# Window and Title
Robotics2_G9_SCARA_FKCalculator = Tk()
Robotics2_G9_SCARA_FKCalculator.title("SCARA Calculator")
Robotics2_G9_SCARA_FKCalculator.resizable(False, False)
Robotics2_G9_SCARA_FKCalculator.configure(bg="tan")
...
FI = LabelFrame(Robotics2_G9_SCARA_FKCalculator,text="Link Lengths and Joint Variables",font=(S),bg="tan")
...
# Button Frame
BF = LabelFrame(Robotics2_G9_SCARA_FKCalculator,text="Forward Kinematics",font=(5),bg="tan",fg="black")
...
PV = LabelFrame(Robotics2_G9_SCARA_FKCalculator,text="Position Vectors",font=(5),bg="tan",fg="black")
...
PI = Label(Robotics2_G9_SCARA_FKCalculator,image=img)
PI.grid(row=3,column=0)

Robotics2_G9_SCARA_FKCalculator.mainloop()
