...
# Window and Title
Robotics2_G9_SCARA_withIKCalculator = Tk()
Robotics2_G9_SCARA_withIKCalculator.title("SCARA Calculator")
Robotics2_G9_SCARA_withIKCalculator.resizable(False, False)
Robotics2_G9_SCARA_withIKCalculator.configure(bg="tan")
...
FI = LabelFrame(Robotics2_G9_SCARA_withIKCalculator,text="Link Lengths and Joint Variables",font=(S),bg="tan")
...
# Button Frame
BF = LabelFrame(Robotics2_G9_SCARA_withIKCalculator,text="Forward Kinematics",font=(5),bg="tan",fg="black")
...
PV = LabelFrame(Robotics2_G9_SCARA_withIKCalculator,text="Position Vectors",font=(5),bg="tan",fg="black")
...
PI = Label(Robotics2_G9_SCARA_withIKCalculator,image=img)
PI.grid(row=3,column=0)

Robotics2_G9_SCARA_withIKCalculator.mainloop()
